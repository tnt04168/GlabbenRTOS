...
//
//	Ulrik Eklund 2014, Sebastian Hoggard 2018
//
//
...
int lcdClearDisplay(void)
{
	...
	// fast way
	//ioport_set_pin_level(LCD_RS, 0);
	//ioport_set_port_level(IOPORT_PIOC, LCD_mask_D4_D7, 0x00000000);
	//ioport_set_pin_level(LCD_Enable, HIGH);
	//delayMicroseconds(1);
	//ioport_set_pin_level(LCD_Enable, LOW);
	//delayMicroseconds(100);
	//ioport_set_port_level(IOPORT_PIOC, LCD_mask_D4_D7, 0x04000000);
	//ioport_set_pin_level(LCD_Enable, HIGH);
	//delayMicroseconds(1);
	//ioport_set_pin_level(LCD_Enable, LOW);
	//delayMicroseconds(100);
